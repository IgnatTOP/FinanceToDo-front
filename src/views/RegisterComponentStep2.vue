<template>
  <ion-page>
    <ion-header collapse="fade" class="ion-no-border bg-gray-100">
      <ion-toolbar class="w-[80%] mx-auto flex justify-center items-center">
    ...
    <ion-content :fullscreen="true" class="ion-padding">
      <div class="flex flex-col">
        <div class="flex justify-center flex-col items-center mt-[2rem]">
          <img src="../img/RetoucherOnlineScreenshotNov20.png" class="img_logo-start" alt="Лого">
          <br>
          <h2 class="text-2xl">Регистрация</h2>
          <br>
          <p class="text-center text-gray-400 w-[80%]">Введите ваш номер мобильного телефона, мы отправим вам одноразовый код для последующей верификации.</p>
        </div>
        <div class="flex flex-col items-center justify-center bg-white w-[90%] py-10 mx-auto rounded-2xl mt-10">
          <div class="w-[90%]">
            <transition name="fade">
              <p v-if="phoneNumberError" class="error-message text-red-500 mt-2 text-sm m-0">Ошибка в номере телефона</p>
            </transition>
            ...
            <router-link to="/register/step/2" class="w-full flex justify-center items-center">
              <a
...
export default {
  ...
  components: {IonTitle, ExploreContainer, IonContent,Icon, IonToolbar, IonPage, IonHeader, ChevronBack, IonInput},
  data() {
    return {
      phoneNumber: "",
  ...
  methods: {
    ...
    continueClicked() {
      ...
      if (!this.phoneNumberError) {
        ...
        // For example, use this.$router.push('/register/step/1');
      }
    },
  },
  }
